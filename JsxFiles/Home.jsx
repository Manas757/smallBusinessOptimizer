...
const Home = () => {
  ...
  return (
    <div className='app-container'>
      <nav className="navbar">
        <div className="navbar-content">
          ...
          <div className="nav-right">
            ...
            <button className='role-btn' onClick={() => setCurrentPage('Cart')} aria-label="cart">🛒</button>
                    ...
                    <div className="card-body">
                      ...
                      <div className="card-footer">
                        ...
                        <div className="button-group">
                          ...
                          <button className="home-view-btn">view</button>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      {currentPage === 'Cart' && <OrderCheckoutPage />}
      {currentPage === 'profile' && <SmallBizProfile />}
